...
<script>
    ...
    export default {
        name: 'MatchingMatchingInfoPicker',
        props: {
        ...
        async created() {
            ...
            if(temp.data) {
                me.list = temp.data._embedded.matchingInfos;
            }

            if(me.value && typeof me.value == "object" && Object.values(me.value)[0]) {
                var id = Object.values(me.value)[0];
                var tmpValue = await axios.get(axios.fixUrl('/matchingInfos/' + id))
                if(tmpValue.data) {
